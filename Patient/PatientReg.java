    ...
    public void actionPerformed(ActionEvent e)
    {
        if (e.getSource() == sub) {
            if (term.isSelected()) {
				...
				PatientAccount account=new PatientAccount(name,pass);
				account.addaccount();
				
				try
				{
					file= new File("Data\\patientlist.txt");
			
					file.createNewFile();
			
					fwriter= new FileWriter(file,true);
			
					fwriter.write("Name: "+tname.getText()+"\t");
					
					fwriter.write("Address: "+tadd.getText()+"\n");
