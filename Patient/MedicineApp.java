...
public class MedicineApp extends JFrame implements ActionListener
{
	...
	public MedicineApp()
	{
		...
		ImageIcon Medicineient = new ImageIcon("imgs\\PatientPortal.png");
        ...
        buy = new JButton("BUY");
		buy.setFont(new Font("Arial Black",Font.PLAIN,14));
		buy.setBounds(690,210,80,50);
		buy.setOpaque(true);
		buy.setBackground(new Color(50, 86, 168));
		buy.setForeground(Color.white);
		buy.setFocusable(false);
		buy.addActionListener(this);
		MedicineApppanel.add(buy, JLayeredPane.DRAG_LAYER);
