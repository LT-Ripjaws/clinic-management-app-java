...
public class PatList extends JFrame implements ActionListener
{
	...
	public PatList()
	{
		...
		JLabel list = new JLabel("PATIENTS REGISTERED:");
		list.setForeground(Color.black);
        list.setFont(new Font("Arial Black",Font.BOLD,18));
        ...
        try {
            ...
            tout.read(new InputStreamReader(Objects.requireNonNull(
                    getClass().getResourceAsStream("/Data/patientlist.txt"))), null);
        } catch (IOException e) {
            e.printStackTrace();
        }
